...
@section('title', 'yana Pro login display')
...
<div class="mt-3 flex justify-center items-center flex-col">
    ...
    @endif
    <form action="" method="post" class="p-2 w-80 bg-teal-500 text-purple-50 block">
        @csrf
        ...
        <div class="mt-2 grid grid-flow-col grid-cols-3 gap-4">
            <button type="submit" class="col-span-3 border border-gray-800 bg-gray-800">ログインする</button>
        </div>
    </form>
</div>
@endsection